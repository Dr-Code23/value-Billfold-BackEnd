    ...
    <div class="container pb-6">
      ...
      <div class="row g-4 g-xl-5">
        ...
        <div class="col-12 col-md-4 d-flex">
          ...
          >
            <div class="sa-widget-header saw-indicator__header">
              <h2 class="sa-widget-header__title">Total Invoices</h2>
              <div class="sa-widget-header__actions">
...
{{--                  <tr>--}}
{{--                    <td>--}}
{{--                      <a href="app-order.html" class="text-reset"--}}
{{--                        >#00745</a--}}
{{--                      >--}}
{{--                    </td>--}}
{{--                    <td>--}}
...
{{--                        class="sa-language-icon d-block"--}}
{{--                        alt=""--}}
{{--                        title="Italy"--}}
{{--                      />--}}
{{--                    </td>--}}
...
{{--                          href="app-customer.html"--}}
{{--                          class="sa-symbol sa-symbol--shape--circle sa-symbol--size--md me-3"--}}
{{--                          ><div class="sa-symbol__text">HW</div></a--}}
{{--                        >--}}
{{--                        <div>--}}
{{--                          <a href="app-customer.html" class="text-reset"--}}
{{--                            >Hans Weber</a--}}
...
{{--                          href="app-customer.html"--}}
{{--                          class="sa-symbol sa-symbol--shape--circle sa-symbol--size--md me-3"--}}
{{--                          ><div class="sa-symbol__text">AR</div></a--}}
{{--                        >--}}
{{--                        <div>--}}
{{--                          <a href="app-customer.html" class="text-reset"--}}
{{--                            >Andrea Rossi</a--}}
...
{{--                    <td>--}}
{{--                      <img--}}
{{--                        src="vendor/flag-icons/24/US.png"--}}
{{--                        class="sa-language-icon d-block"--}}
{{--                        alt=""--}}
{{--                        title="USA"--}}
{{--                      />--}}
...
{{--                          href="app-customer.html"--}}
{{--                          class="sa-symbol sa-symbol--shape--circle sa-symbol--size--md me-3"--}}
{{--                          ><div class="sa-symbol__text">RF</div></a--}}
{{--                        >--}}
{{--                        <div>--}}
{{--                          <a href="app-customer.html" class="text-reset"--}}
{{--                            >Richard Feynman</a--}}
...
{{--                    <td>--}}
{{--                      <img--}}
{{--                        src="vendor/flag-icons/24/CO.png"--}}
{{--                        class="sa-language-icon d-block"--}}
{{--                        alt=""--}}
{{--                        title="Columbia"--}}
{{--                      />--}}
...
{{--                          href="app-customer.html"--}}
{{--                          class="sa-symbol sa-symbol--shape--circle sa-symbol--size--md me-3"--}}
{{--                          ><div class="sa-symbol__text">LG</div></a--}}
{{--                        >--}}
{{--                        <div>--}}
{{--                          <a href="app-customer.html" class="text-reset"--}}
{{--                            >Leonardo Garcia</a--}}
...
{{--                    <td>--}}
{{--                      <img--}}
{{--                        src="vendor/flag-icons/24/RS.png"--}}
{{--                        class="sa-language-icon d-block"--}}
{{--                        alt=""--}}
{{--                        title="Srbija"--}}
{{--                      />--}}
...
{{--                          href="app-customer.html"--}}
{{--                          class="sa-symbol sa-symbol--shape--circle sa-symbol--size--md me-3"--}}
{{--                          ><div class="sa-symbol__text">NT</div></a--}}
{{--                        >--}}
{{--                        <div>--}}
{{--                          <a href="app-customer.html" class="text-reset"--}}
{{--                            >Nikola Tesla</a--}}
...
{{--                          href="app-customer.html"--}}
{{--                          class="sa-symbol sa-symbol--shape--circle sa-symbol--size--md me-3"--}}
{{--                          ><div class="sa-symbol__text">MC</div></a--}}
{{--                        >--}}
{{--                        <div>--}}
{{--                          <a href="app-customer.html" class="text-reset"--}}
{{--                            >Marie Curie</a--}}
...
{{--                          href="app-customer.html"--}}
{{--                          class="sa-symbol sa-symbol--shape--circle sa-symbol--size--md me-3"--}}
{{--                          ><div class="sa-symbol__text">KT</div></a--}}
{{--                        >--}}
{{--                        <div>--}}
{{--                          <a href="app-customer.html" class="text-reset"--}}
{{--                            >Konstantin Tsiolkovsky</a--}}
{{--                          >--}}
{{--                        </div>--}}
{{--                      </div>--}}
{{--                    </td>--}}
