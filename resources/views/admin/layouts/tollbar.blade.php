    ...
    <div class="sa-toolbar__body">
          ...
          <div class="sa-search__dropdown">
            ...
            <div class="sa-search__dropdown-wrapper">
              ...
              <div class="sa-search__help sa-search__help--type--no-results">
                <div class="sa-search__help-title">No results for &quot;
      ...
      <div class="sa-toolbar__item dropdown">
        ...
        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton3">
          <li>
            <a class="dropdown-item d-flex align-items-center" href="{{url('Admin/Lang','en')}}"
              ><img
                src={{asset("assets/vendor/flag-icons/24/US.png")}}
          ...
          <li>
            <a class="dropdown-item d-flex align-items-center" href="{{url('Admin/Lang','ar')}}"
              ><img
                src={{asset("assets/vendor/flag-icons/24/eg.png")}}
                class="sa-language-icon me-3"
                alt=""
      ...
      <div class="dropdown sa-toolbar__item">
        ...
        >
          <span
            ...
            <span class="sa-toolbar-user__title">{{$admin->name}}</span>
            <span class="sa-toolbar-user__subtitle">{{$admin->email}}</span>
              </span>
        </button>
        <ul
