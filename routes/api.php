...
Route::group(['controller' =>AuthController::class , 'prefix'=> 'Auth'],function(){
    ...
    Route::post('change-password','ChangePassword')->middleware(['api.auth','token.status']);
    Route::post('edit-profile','editProfile')->middleware(['api.auth','token.status']);
    Route::get('show-profile','showProfile')->middleware(['api.auth','token.status']);
    Route::get('home','home')->middleware(['api.auth','token.status']);
